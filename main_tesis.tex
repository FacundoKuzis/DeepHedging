...
\begin{table}[H]
\centering
\caption{Métricas del error de cobertura para la opción \textit{call} asiática aritmética geométrica sin costos de transacción.}
...
\begin{table}[H]
\centering
\caption{Métricas del error de cobertura para la opción \textit{call} asiática aritmética geométrica con costos de transacción.}

...
CSV_PATH = os.path.join(ROOT_DIR, "assets", "csvs", "timegan_3000", "spy_2019_2024_1d.csv")
MODEL_PATH = os.path.join(ROOT_DIR, "assets", "models", "timegan_3000", "spy_timegan_N63.pkl")
...
N_SYNTH_PATHS = 3_000
N_REAL_WINDOWS_COMPARE = 3_000
N_PLOT_PATHS = 20
ROLLING_VOL_WINDOW = 20
ACF_MAX_LAG = 10
HIST_BINS = 50

PLOTS_DIR = os.path.join(ROOT_DIR, "assets", "plots", "timegan_3000")
METRICS_PATH = os.path.join(ROOT_DIR, "assets", "csvs", "timegan_3000", "summary_metrics.csv")
